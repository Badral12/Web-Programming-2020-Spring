...
if (typeof Cs142TemplateProcessor !== 'function') {
    ...
    var template = 'My favorite month is {{month}} but not the day {{day}} or the year {{year}}. Hello {{world}}';
    var dateTemplate = new Cs142TemplateProcessor(template);

    var dictionary = {month: 'July', day: '1', year: '2016', world: 'Worlds'};
    var str = dateTemplate.fillIn(dictionary);

    if (str !== 'My favorite month is July but not the day 1 or the year 2016. Hello Worlds') {
